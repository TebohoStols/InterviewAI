    ...
    async function onSubmit(values: z.infer<typeof formSchema>) {
        try{
            ...
            if(type === 'sign-up'){
                ...
                //to be completed at 1:38:00 fo the video
        ...
        <div className='flex flex-col gap-6 card py-14 px-10'>
            ...
            <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6 mt-4 form w-full">
                    {!isSignIn && ( 
                        //If an error shows up in the future, may I remember to import this with @ symbol
                        //Make the form dynamically take in the data from user by using the props here
